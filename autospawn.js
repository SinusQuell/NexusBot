            ...
            if (ctrl && ctrl.my) {
                ...
                if (ctrl.level < 3) { //For RCL1/2
                    ...
                    if (freeSpawn) {
                        ...
                        //var accessibleFieldsS2 = utilities.GetSourceSpaces(thirdSource); // null if no vision, so we are not using it at the moment

                        //TODO: save the source index, too, when scouting rooms to make it easier to assign miners to it  
                        //TODO: turn workers for third source to offshores who just drop the energy and then have some dedicated small carriers
                        if (ctrl.level == 2) {
